...
func TestCreateAndGet(t *testing.T) {
	...
	ts := New()
	id := ts.CreateTask("Welcome", nil, time.Now())
	...
	if task.Text != "Welcome" {
		t.Errorf("got Text=%v, want %v", task.Text, "Welcome")
	}
	...
	ts.CreateTask("Okey!", nil, time.Now())
...
func TestGetTasksByDueDate(t *testing.T) {
	...
	ts := New()
	ts.CreateTask("XY1", nil, mustParseDate("2023-Dec-01"))
	ts.CreateTask("XY2", nil, mustParseDate("2023-Dec-21"))
	ts.CreateTask("XY3", nil, mustParseDate("2023-Dec-01"))
